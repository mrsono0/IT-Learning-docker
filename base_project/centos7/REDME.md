...
- Centos7 기반 ssh + 한글환경
```
    docker build -f Dockerfile.oraxe_18c --tag mrsono0/base_project:oraxe_18c .
    docker run --rm -it -p 5500:5500 -p 8080:8080 -p 1521:1521 mrsono0/base_project:oraxe_18c
    docker push mrsono0/base_project:oraxe_18c
...
(https://www.talkapex.com/2018/10/oracle-xe-18-docker-image/)
...
An example to install APEX into the default container is available [here](#How-to-Install-APEX-in-PDB).
